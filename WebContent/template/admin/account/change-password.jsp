                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h6 class="card-subtitle">修改账户密码</h6>
                            <c:if test='${not empty param.succeed}'>
                            ...
                            <form class="form-horizontal p-t-20" action="/admin/account/password" method="post">
                                <div class="form-group row">
                                    <label for="origin-password" class="col-sm-3 control-label">原密码</label>
                                    <div class="col-sm-9">
                                        <div class="input-group">
                                            <input type="password" name="origin-password" class="form-control"
                                                   id="origin-password" placeholder="原密码">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row m-b-0">
                                    <div class="offset-sm-3 col-sm-9">
                                        <button type="submit" class="btn btn-info waves-effect waves-light">修改密码
                                        </button>
                                    </div>
                                </div>
                            </form>
